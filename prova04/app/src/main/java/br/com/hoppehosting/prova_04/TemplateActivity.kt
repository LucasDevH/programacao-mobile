package br.com.hoppehosting.prova_04

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import br.com.hoppehosting.prova_04.databinding.ActivityTemplateBinding
...
class TemplateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.tradutorBtnEnviar.setOnClickListener {

            val mensagem = mBinding.tradutorTxtMensagem.text.toString()
            val mensagemAntiga = mBinding.tradutorTxtView.text.toString()

            mBinding.tradutorTxtView.text = mensagemAntiga + "\n \n " + mensagem
        }
    }
